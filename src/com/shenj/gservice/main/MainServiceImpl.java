...
public class MainServiceImpl implements MainService{
	...
	public MainServiceImpl( String inputPage , String outputPath, boolean isSync) {
		super();
	...
	private boolean saveOneFile(String filePath){
		...
		ParserOneFileService oneService = new ParserOneFileService(filePath , outputPath ,  pojoName , isSync);
	...
	public static void main(String[] args) {
		...
		MainService mainService = new MainServiceImpl("D:\\input", "D:\\com\\shenj\\teworksandroid\\http" , true);
